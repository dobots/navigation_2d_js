...
//	this.container = new createjs.Container();
	...
	addChild(this.pointContainer);
	addChild(this.lineContainer);
};
...
ROS2D.PolygonMarker.prototype.createPointShape = function(pos) {
	...
	circle.graphics.drawCircle(pos.x, pos.y, this.pointSize);
	return circle;
}


ROS2D.PolygonMarker.prototype.addPoint = function(pos) {
	var circle = createCircleShape(pos);
//	circles.push(circle);
	circleContainer.addChild(circle);
	var line = createLineShape(circleContainer.getChildAt(circleContainer.getNumChildren-2), circle);
//	lines.push(line);
	lineContainer.addChild(line);
}


ROS2dPolygonMarker.prototype.remPoint = function(
